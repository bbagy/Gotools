...
Go_expInfo <- function(Project_name=NA,
  ...
  if (is.na(kit_number) && is.na(prep_number) && is.na(spikein_number)) {
    cat(
        ...
        "2: Illumina V1V2\n",
        "3: Zymo Quick-16S V3V4 Plus NGS Library prep kit (#catalog D6420)\n",
        "4: Zymo Quick-16S V1V2 Plus NGS Library prep kit (#catalog D6434-PS1)\n",
        "5: Zymo Quick-ITS Plus NGS Library Prep Kit (UDI) (#catalog D6425-PS1-4)\n",
        "6: Illumina DNA Prep (#catalog 20060059)\n",
        "7: QIAseq Stranded RNA Lib Kit UDI (#catalog 180450)\n",
        "8: QIAseq UPXome RNA Library Kits (#catalog 334702)\n",
        "9: \n\n",
